...
// the crossing sits between 176 and 192 blocks on the 170-SM part it was swept on, i.e. one
// block per SM, so express it as the SM count of whatever device this build runs on.
