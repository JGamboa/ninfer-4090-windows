...
struct FrontendOptions {
    ...
    // full context, so the cap stays configurable. Zero derives the cap from max_context;
    // production paths normalize an unset value to 8192 in planning/startup.cpp.
