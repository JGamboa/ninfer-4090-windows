...
// Fixed sampling/validation vocab domain for this model family. session_snapshot.cpp uses it to
// reject a restored ledger whose token ids fall outside the servable range.
